...
export function DealForm({
  ...
  async function handleSave() {
    ...
    setSaving(false);
    toast.success(deal ? "Oportunidad actualizada" : "Oportunidad creada");
    onOpenChange(false);
    onSaved();
  }
  ...
  async function handleStatusChange(status: DealStatus) {
    ...
    toast.success(
      status === "won" ? "Marcada como ganada" : status === "lost" ? "Marcada como perdida" : "Oportunidad reabierta",
    );
    onOpenChange(false);
    onSaved();
  }
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="border-t border-border/50 bg-popover/80 p-4">
            <div className="flex gap-2">
              ...
              >
                {saving ? "Guardando..." : deal ? "Guardar cambios" : "Crear oportunidad"}
              </Button>
            </div>
            ...
            {deal &&
              (confirmDelete ? (
                <div className="mt-3 flex items-center justify-between gap-2 rounded-md border border-red-500/30 bg-red-500/10 px-3 py-2 text-xs">
                  <span className="text-red-300">¿Eliminar esta oportunidad?</span>
