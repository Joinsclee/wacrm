...
export function ProfileForm() {
  ...
  return (
    <section className="max-w-2xl animate-in fade-in-50 duration-200">
      <SettingsPanelHead
        title="Tu perfil"
        description="Cómo apareces en toda la app. Tu avatar y tu nombre se muestran en el encabezado, la barra lateral y en cualquier lugar donde te vean tus compañeros."
      />
          ...
          <div className="space-y-2">
            ...
            {emailChangePending && (
              <p className="flex items-start gap-2 rounded-md border border-amber-500/30 bg-amber-500/10 px-3 py-2 text-xs text-amber-700 dark:text-amber-300">
                ...
                <span>
                  Revisa el correo de <strong>{profile?.email}</strong> y{' '}
