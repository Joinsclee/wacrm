...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  ...
  expired: {
    ...
    body: 'Esta invitación expiró. Pídele al administrador de la cuenta que te envíe una nueva — se generan en segundos.',
  },
  server_error: {
    title: 'Algo salió mal',
    body: 'No pudimos verificar esta invitación en este momento. Intenta recargar la página en un instante.',
  },
};
        ...
        <Card className="w-full max-w-md border-border bg-card">
          ...
          <CardContent className="flex flex-col gap-3">
            ...
            <p className="text-center text-xs text-muted-foreground">
              Al aceptar, tu inicio de sesión se moverá a{' '}
              <span className="text-muted-foreground">{peek.account_name}</span>. Se
              eliminará la cuenta personal vacía que creaste al registrarte.
            </p>
          </CardContent>
        </Card>
          ...
          <DialogContent className="bg-popover border-border sm:max-w-md">
            ...
            <div className="space-y-2 py-2 text-xs text-muted-foreground">
              <p>
                ...
                cierra sesión y regístrate de nuevo con una dirección de correo
                diferente. El enlace de invitación seguirá siendo válido mientras
                no haya expirado.
              </p>
            </div>
